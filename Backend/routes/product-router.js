...
const {getProductTypes, createProduct, displayProducts, renderSingleProduct} = require('../controllers/product-controller.js')
...
router.route('/display/:id').get(renderSingleProduct)       // ADD .delete()
